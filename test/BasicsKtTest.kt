...
class BasicsKtTest {
    ...
    @Test
    fun wordCounter() {
        val expectedWordCount = mapOf("this" to 2, "is" to 2, "a" to 2, "sentence" to 2, "too" to 1)
        val testArray :Array<String> = arrayOf("this is a sentence.", "this is a sentence too!")
        kotlin.test.assertEquals(expectedWordCount, wordCounter(testArray))
